export const bank = [
    ...
    },
    {
        ...
        code: [
            {branch:"Victoria Towers, Upperhill",code:001},
            {branch:"Riverside Drive",code:002},
            {branch:"Lunga Lunga Square",code:003},
            {branch:"Ruaraka Branch",code:004}
        ]
    }
]
const branches = []
document.querySelectorAll('tbody tr').forEach(elm=>{
    const [name, code] = elm.querySelectorAll('td')
    branches.push({branch:code.innerText,code:name.innerText})
})
